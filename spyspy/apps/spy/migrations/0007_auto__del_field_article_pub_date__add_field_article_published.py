...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('spy_article', 'pub_date')

        # Adding field 'Article.published'
        db.add_column('spy_article', 'published',
    ...
    def backwards(self, orm):
        ...
        db.add_column('spy_article', 'pub_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Article.published'
        db.delete_column('spy_article', 'published')
    ...
    models = {
        ...
        'spy.article': {
            ...
            'published': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
