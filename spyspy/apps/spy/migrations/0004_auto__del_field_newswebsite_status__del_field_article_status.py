...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewsWebsite.status'
        db.delete_column('spy_newswebsite', 'status')

        # Deleting field 'Article.status'
        db.delete_column('spy_article', 'status')


    def backwards(self, orm):
        # Adding field 'NewsWebsite.status'
        db.add_column('spy_newswebsite', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Article.status'
        db.add_column('spy_article', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
