...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.checker_runtime'
        db.add_column('spy_article', 'checker_runtime',
    ...
    def backwards(self, orm):
        # Deleting field 'Article.checker_runtime'
        db.delete_column('spy_article', 'checker_runtime_id')
