...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('spy_newswebsite', (
        ...
        db.send_create_signal('spy', ['NewsWebsite'])

        # Adding model 'Article'
        db.create_table('spy_article', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('news_website', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spy.NewsWebsite'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('spy', ['Article'])


    def backwards(self, orm):
        # Deleting model 'NewsWebsite'
        db.delete_table('spy_newswebsite')

        # Deleting model 'Article'
        db.delete_table('spy_article')
